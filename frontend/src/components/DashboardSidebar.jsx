...
const DashboardSidebar = () => {
  ...
  return (
    <>
      ...
      <button
        onClick={toggleMenu}
        className="fixed top-4 left-4 z-50 md:hidden bg-indigo-700 text-white p-4 rounded-xl shadow-2xl"
      >
      ...
      {/* Sidebar */}
      <aside
        className={`w-80 bg-gradient-to-b from-indigo-900 via-indigo-800 to-purple-900 text-white min-h-screen fixed left-0 top-0 overflow-y-auto shadow-2xl z-40 transition-transform duration-300 ${
